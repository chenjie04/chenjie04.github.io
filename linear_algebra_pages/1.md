...
语音识别系统
![](../images/Linear_Algebra/1/语音识别系统.png)

对话系统
![](../images/Linear_Algebra/1/对话系统.png)

通信系统
![](../images/Linear_Algebra/1/通信系统.png)
...
![](../images/Linear_Algebra/1/保留乘法.png)

2. 保留加法特性（Persevering addition），即系统的输入增加$x_{2}$,其输出会对应输出$y_{2}$
![](../images/Linear_Algebra/1/保留加法.png)

例子：判断以下系统是否为现象系统

1. 二次函数系统

![](../images/Linear_Algebra/1/x平方.png) 
...
![](../images/Linear_Algebra/1/微分.png)

答：微分是线性系统

![](../images/Linear_Algebra/1/微分_1.png)

3. 定积分系统

![](../images/Linear_Algebra/1/定积分.png)

答：定积分系统是线性的，详见定积分的线性性质：https://blog.csdn.net/phoenix198425/article/details/78757050

4. 多输入输出系统

![](../images/Linear_Algebra/1/多输入输出系统.png)
...
![](../images/Linear_Algebra/1/电路.png)

* 通信系统

![](../images/Linear_Algebra/1/通信.png)

* 信号处理（傅里叶变换）

![](../images/Linear_Algebra/1/傅里叶变换.png)

* 气象预测

![](../images/Linear_Algebra/1/气象预测.png)
![](../images/Linear_Algebra/1/气象预测_1.png)

* 计算机图形学

![](../images/Linear_Algebra/1/计算机图形学.png)

* 搜索引擎

![](../images/Linear_Algebra/1/搜索引擎.png)
